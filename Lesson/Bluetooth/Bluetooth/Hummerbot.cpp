...
void Hummerbot::SetUltrasonicPin(uint8_t Trig_Pin = HB_TRIGPIN, uint8_t Echo_Pin = HB_ECHOPIN, uint8_t Sevo_Pin = HB_SEVOPIN)
{
    TrigPin = Trig_Pin;
    EchoPin = Echo_Pin;
    SevoPin = Sevo_Pin;
...
void Hummerbot::SetPs2Pin(uint8_t clk, uint8_t cmd, uint8_t att, uint8_t dat)
{
    DEBUG_LOG(DEBUG_LEVEL_INFO, "SetPs2Pin \n");
}
