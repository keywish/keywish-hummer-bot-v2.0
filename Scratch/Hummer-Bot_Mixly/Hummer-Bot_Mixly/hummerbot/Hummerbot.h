...
public :
    ...
    uint16_t GetUltrasonicDistance(byte direction);//front 0 left 1 right 2
    uint8_t GetInfraredAvoidance(byte direction); //left 0 right 1
    void SetServoPin(uint8_t Servo_Pin = HB_SERVOPIN); 
